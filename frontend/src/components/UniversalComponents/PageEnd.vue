<template>
  <div class="fixed inset-0 flex items-center justify-center z-30 pointer-events-none">
    <div class="w-full max-w-2xl px-4 transform transition-all duration-300"
         :class="{ 'opacity-0 translate-y-20': !isVisible, 'opacity-100 translate-y-0': isVisible }">
      <div class="relative group cursor-pointer pointer-events-auto" @click="navigateToNext">
        <div class="relative p-12 rounded-lg transition-all duration-300 overflow-hidden backdrop-blur-sm bg-black/60 
          ...
          <div class="flex flex-col h-full items-center justify-center">
            ...
            <div class="flex flex-col items-center text-center mb-8">
              ...
              <p class="text-3xl font-raleway font-light tracking-[0.15em] text-white/90 group-hover:text-white transition-colors duration-300">{{ nextArtifactTitle }}</p>
            </div>
