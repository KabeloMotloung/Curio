        ...
        <div class="relative p-12 rounded-lg transition-all duration-300 overflow-hidden backdrop-blur-sm bg-black/60 
          ...
          <div class="flex flex-col h-full items-center justify-center">
            ...
            <div class="flex flex-col items-center text-center mb-8">
              ...
              <p class="text-3xl font-raleway font-light tracking-[0.15em] text-white/90 group-hover:text-white transition-colors duration-300">The Discovery</p>
            </div>
...
const artifactImage = theDiscoverImage;
