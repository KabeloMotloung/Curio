<template>
    <div class="scroll-container">
      ...
      <section class="panel panel1"><div class="text">Tapestry is more than just woven threads. Each strand tells a story, and together they form a masterpiece that transcends time.</div></section>
      <section class="panel panel2"><div class="text">Threads of history, culture, and artistry weave together to create a tapestry that speaks to the soul. The Life of Shaka captures this in its rich display of South African History</div></section>
      ...
      <section class="horizontal-panel-wrapper" ref="horizontalWrapper">
        <div class="horizontal-panels" ref="horizontalPanels">
          <div class="horizontal-panel panel3a">
            <div class="text">The piece spans over four and a half meters in length and was crafted with pure karakul hand-spun wool and linen</div>

          </div>
          <div class="horizontal-panel panel3b"><div class="text">Its vibrant hues and intricate design bring to life the legacy of Shaka Zulu, the legendary king of the Zulu nation.</div></div>
          <div class="horizontal-panel panel3c"><div class="text">Under the guidance of master weaver Allina Ndebele, Memela and Shabalala spent four and a half months weaving this exceptional piece</div></div>
        </div>
      </section>
  
      <section class="panel panel4"><div class="text">Tapestry, as a medium, is a testament to patience and collaboration and The Life of Shaka is not exempt from this truth</div></section>
      <section class="panel panel5"><div class="text">The Life of Shaka" tapestry is not just an artwork; it is a cultural treasure.</div></section>
    </div>
  </template>
